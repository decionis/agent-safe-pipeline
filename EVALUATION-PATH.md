...
| Executor isolation itself (the container runtime, Pod Security Admission, the network policy), agent egress denial, provider credential scoping, monitoring of direct provider calls, incident response                                                                                                                                   | Your host; declared in `deploy/`, not verifiable from inside the process                                    | [THREAT-MODEL.md](./THREAT-MODEL.md) "Accepted risks", [docs/trust-boundary.md](./docs/trust-boundary.md)                                                 |
