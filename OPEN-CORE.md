...
| Trusted executor process and deployment kit                               | `examples/trusted-executor`, `deploy/`        | The boundary has to be deployable inside the customer's trust domain with its handler seam, image and manifest inspectable |
