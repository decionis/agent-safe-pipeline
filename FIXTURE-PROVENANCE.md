...
| Integration harness               | `tests/integration/*/*.mjs`              | Wire-contract harness and packed-package consumer using synthetic tenants, actors, orders, grants, and receipts against the loopback doubles shipped in the package testing entry                    | Packed-package and wire-contract tests only                       |
