...
class Agentsafe < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/decionis/agent-safe-pipeline/releases/download/v0.1.0/agentsafe-0.1.0-darwin-arm64.tar.gz"
      sha256 "7729507b1cf7dac6de677c88f8bfbe00d92c1dd817c89f40158d7886ce874843"
    end
    on_intel do
      url "https://github.com/decionis/agent-safe-pipeline/releases/download/v0.1.0/agentsafe-0.1.0-darwin-x64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/decionis/agent-safe-pipeline/releases/download/v0.1.0/agentsafe-0.1.0-linux-arm64.tar.gz"
      sha256 "157a4174bbc469d3c445598701060e7cc44493ecbaa88b39f7f7cd3ccc8faae8"
    end
    on_intel do
      url "https://github.com/decionis/agent-safe-pipeline/releases/download/v0.1.0/agentsafe-0.1.0-linux-x64.tar.gz"
