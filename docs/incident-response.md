...
|                   |                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **You would see** | `EFFECT_MISMATCH` with the differing field names, or `EFFECT_RECEIPT_MISMATCH` when the provider's own signed receipt says something else than what was observed, and a halt with trigger `EFFECT_MISMATCH`; or `agentsafe_open_attempts{state="UNKNOWN"}` above zero; or `EFFECT_PENDING_CONFIRMATION` on every commit, which means nothing is being read back at all |
