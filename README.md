...
- [`govern/`](./govern) — Govern, the gate for CI workflows: the `decionis/govern` action (`uses: decionis/govern@v1`) as it shipped at v1.9.0, moved here on 2026-09-21; its Go rewrite, one binary for GitHub Actions, GitLab CI, Jenkins and other runners speaking the execution contract the runtime speaks, follows.
