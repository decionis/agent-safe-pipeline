...
| [`intercept/`](./intercept)                                         | The transparent interceptor beside a workload of yours: a Kubernetes Component, a Docker recipe, and the govern example with the operator authority |
